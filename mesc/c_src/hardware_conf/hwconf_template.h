...
// Normal SVPWM implemented as midpoint clamp. If not defined, you will get 5 sector, bottom clamp
// #define SEVEN_SECTOR		
...
// FIXME: stub, make it work properly. Also should not be in the hardware config
