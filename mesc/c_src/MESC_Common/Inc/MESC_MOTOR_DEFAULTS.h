...
#elif defined(QS165)
#define MAX_MOTOR_PHASE_CURRENT \
    350.0f  // 350A seems like a reasonable upper limit for these
...
#define DEFAULT_MOTOR_PP 7            // Pole Pairs
// This assumes a 6.5mohm QS165 and 1.5mohm of MOS and cable. With such low resistance, it
// becomes important

#elif defined(QS165V2)
#define MAX_MOTOR_PHASE_CURRENT \
    600.0f  // 600A seems like a reasonable upper limit for these V2
...
// This assumes a 4.5mohm QS165V2 and 1.5mohm of MOS and cable. With such low resistance,
// it becomes important

#elif defined(QS165_50H)
#define MAX_MOTOR_PHASE_CURRENT \
    800.0f  // 800A seems like a reasonable upper limit for these V2
...
#define DEFAULT_MOTOR_PP 5            // Pole Pairs
// This assumes a 1.7mohm QS165V2 and 1.0mohm of MOS and cable. With such low resistance,
// it becomes important
...
#define DEFAULT_MOTOR_Ld \
    0.0000025f  // Henries Could be anything, but setting it low means the current
                // controller P term will be more stable/slower
#define DEFAULT_MOTOR_Lq 0.0000025f  // Henries
#define DEFAULT_MOTOR_R \
    0.0050f  // Ohms Could be anything, but setting it lower means slower I term on the
             // PID
#define DEFAULT_MOTOR_PP 7  // Pole Pairs
