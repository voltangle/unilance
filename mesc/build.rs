...
fn main() {
    ...
    cc::Build::new()
        ...
        .include("c_src/")
        .include("c_src/STM32CubeF4-CMSIS/Device/ST/STM32F4xx/Include")
        .include("c_src/STM32CubeF4-CMSIS/Include")
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_arg("-I./c_src/STM32CubeF4-CMSIS/Device/ST/STM32F4xx/Include")
        .clang_arg("-I./c_src/STM32CubeF4-CMSIS/Include")
