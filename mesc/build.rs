...
fn main() {
    ...
    cc::Build::new()
        ...
        .include("c_src/")
        .include("c_src/hardware_conf/bg_etmax")
    ...
    let bindings = bindgen::Builder::default()
        ...
        // FIXME: NO ABSOLUTE PATHS HERE. Make it so this script automatically adapts to
        // the selected target.
        .clang_arg("-I./c_src/hardware_conf/bg_etmax/")
        ...
        .header("c_src/hardware_conf/bg_etmax/mesc_wrap.h")
        .use_core()
        .derive_default(true)
